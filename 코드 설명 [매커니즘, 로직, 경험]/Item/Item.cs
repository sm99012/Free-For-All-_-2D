...
public class Item : MonoBehaviour
{
    ...
    public int m_nItemCode;                     // 아이템 고유코드
                                                ...
                                                //    장비아이템(주무기(단검)) 고유코드 : 1300 ~ 1599
                                                //    장비아이템(주무기(도끼)) 고유코드 : 1600 ~ 1899
                                                //    장비아이템(주무기(기타)) 고유코드 : 1900 ~ 1999
    ...
    public STATUS m_sStatus_Limit_Max; // 스탯(능력치) 상한(플레이어의 능력치 합계가 아이템 착용 및 사용 조건(능력치 상한)을 초과한 경우 제한)
    public STATUS m_sStatus_Limit_Min; // 스탯(능력치) 하한(플레이어의 능력치 합계가 아이템 착용 및 사용 조건(능력치 하한)에 미달한 경우 제한)
    // 아이템 착용 및 사용 조건 - 스탯(평판) 상한ㆍ하한
    public SOC m_sSoc_Limit_Max; // 스탯(평판) 상한(플레이어의 평판 합계가 아이템 착용 및 사용 조건(평판 상한)을 초과한 경우 제한)
    public SOC m_sSoc_Limit_Min; // 스탯(평판) 하한(플레이어의 평판 합계가 아이템 착용 및 사용 조건(평판 하한)에 미달한 경우 제한)
