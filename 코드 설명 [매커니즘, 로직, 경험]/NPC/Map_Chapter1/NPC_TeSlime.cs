...
public class NPC_TeSlime : NPC_Total
{
    private void Awake()
    {
    ...
    override public void InitialSet()
    {
        ...
        m_ql_QuestList_KILL_MONSTER.Add(QuestManager.Instance.GetQuest_KILL_MONSTER(0010));
        m_ql_QuestList_KILL_MONSTER.Add(QuestManager.Instance.GetQuest_KILL_MONSTER(0011));
