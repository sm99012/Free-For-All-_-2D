...
public class NPC_KidEnts : NPC_Total
{
    private void Awake()
    {
        m_sNPCName = "꼬마 앤트";
    ...
    override public void InitialSet()
    {
        ...
        m_cl_Conversation.Add(ConversationManager.Instance.m_Dictionary_ConversationList[34]);
        ...
        m_ql_QuestList_COLLECT.Add(QuestManager.Instance.GetQuest_COLLECT(4013));
