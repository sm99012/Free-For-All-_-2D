...
public class NPC_HappyDeepEnts : NPC_Total
{
    private void Awake()
    {
        m_sNPCName = "행복한 짙은 앤트";
        m_nNPCCode = 9;
    ...
    override public void InitialSet()
    {
        ...
        m_cl_Conversation.Add(ConversationManager.Instance.m_Dictionary_ConversationList[12]);
        m_ql_QuestList_GOAWAY_MONSTER.Add(QuestManager.Instance.GetQuest_GOAWAY_MONSTER(2001));
        m_ql_QuestList_CONVERSATION.Add(QuestManager.Instance.GetQuest_CONVERSATION(5004));
    }
}
