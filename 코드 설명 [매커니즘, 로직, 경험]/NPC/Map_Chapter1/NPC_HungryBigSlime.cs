...
public class NPC_HungryBigSlime : NPC_Total
{
    private void Awake()
    {
    ...
    override public void InitialSet()
    {
        ...
        m_cl_Conversation.Add(ConversationManager.Instance.m_Dictionary_ConversationList[8]);
        m_ql_QuestList_COLLECT.Add(QuestManager.Instance.GetQuest_COLLECT(4002));
    }
}
