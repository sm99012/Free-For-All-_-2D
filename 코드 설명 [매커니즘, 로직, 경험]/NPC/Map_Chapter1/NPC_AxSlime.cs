...
public class NPC_AxSlime : NPC_Total
{
    private void Awake()
    {
        m_sNPCName = "[중급 용병]\n엑스을라";
    ...
    override public void InitialSet()
    {
        ...
        m_cl_Conversation.Add(ConversationManager.Instance.m_Dictionary_ConversationList[26]);
        ...
        m_ql_QuestList_COLLECT.Add(QuestManager.Instance.GetQuest_COLLECT(4011));
