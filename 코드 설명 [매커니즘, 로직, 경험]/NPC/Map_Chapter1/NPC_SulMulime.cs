...
public class NPC_SulMulime : NPC_Total
{
    private void Awake()
    {
        m_sNPCName = "[중급 용병]\n술무라임";
    ...
    override public void InitialSet()
    {
        ...
        m_cl_Conversation.Add(ConversationManager.Instance.m_Dictionary_ConversationList[27]);
        ...
        m_ql_QuestList_GOAWAY_TYPE.Add(QuestManager.Instance.GetQuest_GOAWAY_TYPE(3001));
        m_ql_QuestList_COLLECT.Add(QuestManager.Instance.GetQuest_COLLECT(4012));
