...
public class NPC_Tombstone1 : NPC_Total
{
    private void Awake()
    {
        m_sNPCName = "누군가의 무덤";
    ...
    override public void InitialSet()
    {
        ...
        m_ql_QuestList_CONVERSATION.Add(QuestManager.Instance.GetQuest_CONVERSATION(5000));

        m_cl_Conversation.Add(ConversationManager.Instance.m_Dictionary_ConversationList[21]);
    }
}
