...
public class NPC_Gamjya : NPC_Total
{
    private void Awake()
    {
        m_sNPCName = "감쟈";
    ...
    override public void InitialSet()
    {
        ...
        m_ql_QuestList_COLLECT.Add(QuestManager.Instance.GetQuest_COLLECT(4001));

        m_cl_Conversation.Add(ConversationManager.Instance.m_Dictionary_ConversationList[2]);
    }
