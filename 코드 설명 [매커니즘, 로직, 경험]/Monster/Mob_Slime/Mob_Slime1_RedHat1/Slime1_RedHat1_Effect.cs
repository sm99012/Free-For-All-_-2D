...
public class Slime1_RedHat1_Effect : Slime1_Effect // 기반이 되는 Slime1_Effect 클래스 상속
{
    ...
    // 몬스터 ㆍㆍㆍ 이펙트 연출 함수 - "상인단 경비 초원 슬라임"은 별도의 추가 이펙트를 가지지 않는다.
    override public void Effect1(Vector3 pos) { }
    // 몬스터 ㆍㆍㆍ 이펙트 연출 코루틴 - "상인단 경비 초원 슬라임"은 별도의 추가 이펙트를 가지지 않는다.
