...
//
// ※ "상인단 경비 초원 슬라임"은 "초원 슬라임"이 현실에 타협해 먹고살기 위해 어쩔 수 없이 강해진 개체이다.
//    "상인단 경비 초원 슬라임"은 이동형 몬스터로 설계했다. 평범한 속도로 이동한다. 방어력이 제법 높은 편이다.
//    "상인단 경비 초원 슬라임"은 공격 시 몸을 뻗어 오브젝트(플레이어)와 충돌하는 공격을 한다.
//    "초원 슬라임"과 비교해 스탯(능력치, 평판), 생김새에 차이가 존재한다.
//

public class Slime1_RedHat1_Total : Slime1_Total // 기반이 되는 Slime1_Total 클래스 상속
{
