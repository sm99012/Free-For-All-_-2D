...
//
// ※ "꼬마 초원 슬라임"은 "초원 슬라임"의 어린 개체이다.
//    "꼬마 초원 슬라임"은 이동형 몬스터로 설계했다. 느린 속도로 이동하며 매우 약하다.
//    "꼬마 초원 슬라임"은 공격 시 몸을 뻗어 오브젝트(플레이어)와 충돌하는 공격을 한다.
//    "초원 슬라임"과 비교해 스탯(능력치, 평판), 크기, 생김새에 차이가 존재한다.
//

public class Slime3_Total : Slime1_Total // 기반이 되는 Slime1_Total 클래스 상속
{
