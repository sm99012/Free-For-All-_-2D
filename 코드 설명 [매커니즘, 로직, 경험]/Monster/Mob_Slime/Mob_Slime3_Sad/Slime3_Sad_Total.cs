...
//
// ※ "슬픈 꼬마 초원 슬라임"은 "초원 슬라임"의 어린 개체이다. 이유는 모르겠으나 울고 있다.
//    "슬픈 꼬마 초원 슬라임"은 이동형 몬스터로 설계했다. 제법 빠른 속도로 이동하며 매우 약하지만 공격속도가 빠른 편이다.
//    "슬픈 꼬마 초원 슬라임"은 공격 시 몸을 뻗어 오브젝트(플레이어)와 충돌하는 공격을 한다.
//    "초원 슬라임"과 비교해 스탯(능력치, 평판), 크기에 차이가 존재한다.
//

public class Slime3_Sad_Total : Slime1_Total // 기반이 되는 Slime1_Total 클래스 상속
{
