...
public class Slime3_Sad_Status : Monster_Status
{
    void Start()
    {
    ...
    {
        m_sSoc_null = new SOC();
        m_sSoc_Goaway = new SOC(0, 0, 0, 1, 0, 0, 0, 0, 0);
        m_sSoc_Death = new SOC(0, 0, 0, -1, 0, 0, 0, 0, 0);
    }

    override public void InitialSet_STATUS()
    {
        m_sStatus = new STATUS(1, 0, 0, 3, 3, 0, 0, 1, 1, 1, 0, 0, 40, 0, 0, 0, 1);
