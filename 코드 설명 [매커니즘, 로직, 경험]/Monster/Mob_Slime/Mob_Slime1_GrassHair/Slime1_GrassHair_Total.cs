...
//
// ※ "잔디 머리 초원 슬라임"은 "초원 슬라임"이 개성을 가져 강해진 개체이다.
//    "잔디 머리 초원 슬라임"은 이동형 몬스터로 설계했다. 평범한 속도로 이동하며 약하다.
//    "잔디 머리 초원 슬라임"은 공격 시 몸을 뻗어 오브젝트(플레이어)와 충돌하는 공격을 한다.
//    "초원 슬라임"과 비교해 스탯(능력치, 평판), 생김새에 차이가 존재한다.
//

public class Slime1_GrassHair_Total : Slime1_Total // 기반이 되는 Slime1_Total 클래스 상속
{
