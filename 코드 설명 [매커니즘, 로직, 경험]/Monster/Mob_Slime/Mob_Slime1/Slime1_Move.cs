...
public class Slime1_Move : Monster_Move // 기반이 되는 Monster_Move 클래스 상속
{
    private void Awake()
    {
    ...
    // 몬스터 추격 함수 - "초원 슬라임"은 평범한 속도로 오브젝트(플레이어)를 추격한다.
    ...
    // 몬스터 공격 함수 - "초원 슬라임"은 공격 시 몸을 뻗어 오브젝트(플레이어)와 충돌하는 공격을 한다.
