...
public class Slime1_Effect : Monster_Effect // 기반이 되는 Monster_Effect 클래스 상속
{
    ...
    // 몬스터 ㆍㆍㆍ 이펙트 연출 함수 - "초원 슬라임"은 별도의 추가 이펙트를 가지지 않는다.
    override public void Effect1(Vector3 pos) { }
    // 몬스터 ㆍㆍㆍ 이펙트 연출 코루틴 - "초원 슬라임"은 별도의 추가 이펙트를 가지지 않는다.
