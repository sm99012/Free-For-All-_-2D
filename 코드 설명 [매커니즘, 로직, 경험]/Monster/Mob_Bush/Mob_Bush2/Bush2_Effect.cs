...
public class Bush2_Effect : Bush1_Effect // 기반이 되는 Bush1_Effect 클래스 상속
{
    ...
    // 몬스터 ㆍㆍㆍ 이펙트 연출 함수 - "가시덤불"은 별도의 추가 이펙트를 가지지 않는다.
    override public void Effect1(Vector3 pos) { }
    // 몬스터 ㆍㆍㆍ 이펙트 연출 코루틴 - "가시덤불"은 별도의 추가 이펙트를 가지지 않는다.
