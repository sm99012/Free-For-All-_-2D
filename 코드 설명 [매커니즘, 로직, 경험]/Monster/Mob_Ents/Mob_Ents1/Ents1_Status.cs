...
public class Ents1_Status : Monster_Status // 기반이 되는 Monster_Status 클래스 상속
{
    void Start()
    {
    ...
    {
        m_sStatus = new STATUS(12, 0, 13, 80, 80, 0, 0, 8, 8, 0, 0, 0, 15, 15, 15, 0, 5); // 레벨 : 12
                                                                                          // 최대체력 : 80
                                                                                          // 데미지(총데미지) : 8
                                                                                          // 이동속도 : 15
                                                                                          // 방어력(물리방어력) : 15
        ...
        m_sStatus_Death = new STATUS(0, 0, 13); // 몬스터 토벌 시 획득 가능한 스탯(능력치)
                                                // 현재경험치 + 13
    }
